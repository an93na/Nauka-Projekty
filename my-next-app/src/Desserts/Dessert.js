...
export const Dessert = (props) => {
  ...
  return (
    <div style={{ padding: '10px', display: 'flex', flexDirection: 'column', alignItems: 'center', position: 'relative' }}>
      ...
      <button style={{ width: '70%', borderRadius: '50px', color: 'gray', backgroundColor: 'white', fontWeight: 'bold', border: '1px solid gray', position: 'absolute', bottom: '35%' }}><img src={shopping} alt="icon-basket" style={{ width: '12%', height: '10%', padding: '1px' }} />Add to Card</button>
