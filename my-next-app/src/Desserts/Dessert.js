...
export const Dessert = (props) => {
  ...
  return (
    <div style={{ padding: '10px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      <button style={{width: '180px', borderRadius: '50px', color: 'gray', backgroundColor: 'white', fontWeight: 'bold', border: '1px solid gray'}}>Add to Card</button>
      <p style={{marginBottom: '0px'}}>{tekst}</p>
