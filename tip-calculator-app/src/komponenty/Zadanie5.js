...
import { four, one, three, two } from './zad3Slice'
            ...
            <form action="" onSubmit={handleSubmit} >
                <div className={classes.zad5Form}>
                    <div className={classes.zad5StyleDiv}>
                        ...
                        <select name="" id="" style={{ width: 168 }} value={stateOne} onChange={(e) => dispatch(one(e.target.value))} >
                    ...
                    <div className={classes.zad5StyleDiv}>
                        ...
                        <select name="" id="" style={{ width: 168 }} value={stateTwo} onChange={(e) => dispatch(two(e.target.value))}>
                            <option value="" hidden>Wybierz</option>
                    ...
                    <div className={classes.zad5StyleDiv}>
                        ...
                        <select name="" id="" style={{ width: 168 }} value={stateThree} onChange={(e) => dispatch(three(e.target.value))}>
                            <option value="" hidden>Wybierz</option>
                    ...
                    <div className={classes.zad5StyleDiv}>
                        ...
                        <select name="" id="" style={{ width: 168 }} value={stateFour} onChange={(e) => dispatch(four(e.target.value))}>
                            <option value="" hidden>Wybierz</option>
